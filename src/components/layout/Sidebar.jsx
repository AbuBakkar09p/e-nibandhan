    ...
    <div className="w-64 bg-white border-r border-slate-200 h-[calc(100vh-64px)] sticky top-16 hidden lg:flex flex-col p-4">
      <div className="space-y-1">
        ...
        <div className="pt-1">
          ...
          >
            <span className={`transition-colors ${location.pathname === '/verify' ? 'text-emerald-600' : 'text-slate-400 group-hover:text-emerald-500'}`}>
              <Fingerprint size={20} />
            </span>
            <span className="text-sm">সনদ যাচাই করুন</span>
          </Link>
        </div>
